...
Proof.
  ...
  induction Hy1; intros y2 Hy2. (* intros y2 Hy2 in every case *)
...
Proof.
  ...
  - unfold normal_form. unfold not. intros. apply H.
    exists (P (C 0) (C 0)). apply ST_Plus1.
    apply ST_PlusConstConst.
Qed. 
End Temp1.
...
Proof.
  ...
  - intros. inversion P21;subst.
    +  (* H contras P22 *)
      exfalso. unfold step_normal_form in P22. unfold normal_form in P22.
      apply P22. exists xmy. apply H.
    + assert (y = xmy) as ass.
      { apply step_deterministic with x. apply H0. apply H. }
      rewrite ass in H1. apply IHP11.
      apply P12. apply H1. apply P22.
Qed.
